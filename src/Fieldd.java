...
public class Fieldd {
    ...
    public Fieldd(int sideLength, double grassPercent, double maleSheepPercent, double femaleSheepPercent, double maleWolfPercent, double femaleWolfPercent, int grassHealth, int sheepHealth, int wolfHealth) {
